...
class ImageClassifier(torch.nn.Module):
    ...
    def forward(self, inputs, dataset_name_ind = None):
        features = self.image_encoder(inputs, dataset_name_ind = dataset_name_ind)
        outputs = self.classification_head(features)
        return outputs

    def __call__(self, inputs, dataset_name_ind = None):
        return self.forward(inputs, dataset_name_ind = dataset_name_ind)
